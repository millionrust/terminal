...
use termirust_domain::{
    ...
    ControllerDeviceError, ControllerDeviceId, PairedDeviceStatus,
};
...
mod tests {
    ...
    use termirust_domain::{
        ...
        DeviceStoreRevision, HostIdentityGeneration, HostIdentityPublic, HostIdentitySecretRef,
        HostIdentityState, HostPublicKey, PairedDeviceRecord, PairingOfferId,
    };
    ...
    fn controller_devices_revoke_commits_before_closing_channels() {
        ...
        service.revoke(device_id).unwrap();
        assert_eq!(
