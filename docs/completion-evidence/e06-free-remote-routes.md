...
- `docs/completion-evidence/e06.1-remote-route-contract.md`
- `docs/completion-evidence/e06.2-desktop-route-coordinator.md`
- `docs/completion-evidence/e06.3-unified-ios-remote-routes.md`
- `docs/completion-evidence/e06.4-unified-android-remote-routes.md`
- `docs/completion-evidence/e06.5-remote-route-acceptance.md`
