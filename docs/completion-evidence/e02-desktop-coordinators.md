...
Canonical child reports are `docs/completion-evidence/e02.1-*.md` through
`docs/completion-evidence/e02.18-*.md`. The final Canvas sequence is:
...
- `python3 scripts/dev/clippy-changed.py`: PASS for every finite child
