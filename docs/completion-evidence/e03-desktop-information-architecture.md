...
- `docs/completion-evidence/e03.1-primary-navigation.md`
- `docs/completion-evidence/e03.2-unified-sessions-library.md`
- `docs/completion-evidence/e03.3-files-and-artifacts-library.md`
- `docs/completion-evidence/e03.4-cross-entry-launch-recovery.md`
- `docs/completion-evidence/e03.5-keyboard-command-palette-conformance.md`
