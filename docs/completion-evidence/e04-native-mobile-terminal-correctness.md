...
- E04.1 core cross-platform terminal conformance:
  `docs/completion-evidence/e04.1-cross-platform-terminal-conformance-v1.md`
- E04.2 style, Unicode width, and resize conformance:
  `docs/completion-evidence/e04.2-native-style-unicode-resize-conformance.md`
- E04.3 selection, clipboard, keyboard, and IME conformance:
  `docs/completion-evidence/e04.3-native-selection-clipboard-keyboard-ime-conformance.md`
- E04.4 adaptive layout, accessibility, performance, and lifecycle acceptance:
  `docs/completion-evidence/e04.4-adaptive-accessibility-performance-lifecycle.md`
