...
- Implemented: SSH hosts, quick connect, imported SSH config hosts, reusable local identities, known-host pinning, tabs, split panes, reconnect, logs, and restorable workspaces.
