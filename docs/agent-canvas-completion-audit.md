...
| --- | --- | --- | --- |
| Existing TermiRust behavior and tests pass | Proved | `cargo test -q`: 294 passed, 0 failed, 3 opt-in live checks ignored; Docker SSH, SFTP, forwarding, jump-host, restore, and tmux tests ran. | None for automated regression scope. |
